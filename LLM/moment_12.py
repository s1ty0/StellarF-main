...
def main(args):
    ...
    # 配置检查点回调
    checkpoint_callback = ModelCheckpoint( # todo, 断联重连
        monitor='val_f1',
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default='./moment_saved_1_12', help='Output directory for saved model')
